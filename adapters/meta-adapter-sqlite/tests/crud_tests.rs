...
async fn test_update_tenant() {
	...
	let update_data = UpdateTenantData { tn_id, id_tag: Patch::Undefined, name: Patch::Value("Robert".into()), typ: Patch::Undefined };
...
async fn test_list_profiles() {
	...
	let opts = ListProfileOptions { typ: None, status: None, connected: None, following: None, q: None, id_tag: None };
