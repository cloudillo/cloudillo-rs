...
async fn main() {
	...
	let crdt_config = CrdtConfig { max_instances: 100, idle_timeout_secs: 3600, broadcast_capacity: 128, auto_evict: true };
	...
	let rtdb_config = RtdbConfig { max_instances: 100, idle_timeout_secs: 3600, broadcast_capacity: 128, auto_evict: true };
